...
handler.before = async function (m) {
    ...
    if (m.quoted.id == this.caklontong[id][0].id) {
        ...
        if (m.text.toLowerCase() == json.jawaban.toLowerCase().trim()) {
            ...
            await this.sendButton(m.chat, `Selamat *@${m.sender.split(`@`)[0]}* jawaban kamu benar, bonus +${this.caklontong[id][2]} XP\n\n${json.deskripsi}`, wm, 'Cak Lontong', '.caklontong', m, {mentions: [m.sender]})
